...
# Import UserAgent but DO NOT initialize it yet (Lazy Loading)
try:
...
def method_2_curl_cffi(symbol="RMF26"):
    ...
    except Exception as e: print(f"  ⚠️ Method 2 error: {e}")
    return None
...
def method_3_antibot(symbol="RMF26"):
    ...
    # ⚠️ LAZY LOADING: Only load UserAgent if we actually reach Method 3
...
def get_barchart_robusta_jan26():
    ...
    print("❌ All Smart Methods Failed")
    return None